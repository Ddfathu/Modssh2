...
=================================================
                  SELAMAT MENIKMATI
             PREMIUM SSH SERVER DROPBEAR modssh2        
=================================================
...
echo -e "\e[1;37m OS           : \e[1;33mUbuntu (Dropbear Enhanced Mode)\e[0m"
echo -e "\e[1;36m=================================================\e[0m"
...
# -W 65536 = Sinkron dengan buffer size pada ws-proxy.py
/usr/sbin/dropbear -p 127.0.0.1:22 -b /etc/dropbear_banner -W 65536
sleep 1 # Beri jeda 1 detik agar port 22 siap sepenuhnya
...
echo "[*] Menambahkan alias di .bashrc..."
cat <<'EOF'>> ~/.bashrc
clear
alias c='clear'
alias x='exit'
...
# Beri jeda sebentar agar semua service internal binding dengan sempurna sebelum Mux dibuka
sleep 1
